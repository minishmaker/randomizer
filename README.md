...
* LoadCosmetics (Cosmetics String) - Loads the cosmetics provided by the cosmetics string into the randomizer.
...
* SaveDefaultLogic (Output Path) - Writes the default logic used by the randomizer to the output path.
