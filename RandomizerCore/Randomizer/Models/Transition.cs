...
namespace RandomizerCore.Randomizer.Models
{
    ...
    {
        public uint EntranceAddress1 { get; set; }
        public uint EntranceAddress2 { get; set; } = 0;
        public uint EntranceAddress3 { get; set; } = 0;

        public ushort ExitX { get; set; }
        public ushort ExitY { get; set; }

        public ushort GreenWarpExitCoordinate { get; set; }

        public ushort ElementGetExitX { get; set; }
        public ushort ElementGetExitY { get; set; }

        public byte EntranceArea { get; set; }
        public byte EntranceRoom { get; set; }
        ...
        public virtual Dictionary<uint, object> GetTransitionOffsets(byte targetArea, byte targetRoom, byte layerOrHeight, byte animation, ushort entranceX, ushort entranceY, byte facingDirection, uint entranceAddress = 0, uint greenWarpAddress = 0, uint elementGetAddress = 0, uint holeTransitionAddress = 0)
        {
            ...
            if (holeTransitionAddress != 0)
            {
                ...
                addressValuePairs.Add(holeTransitionAddress + 0x3, ExitX);
                addressValuePairs.Add(holeTransitionAddress + 0x5, ExitY);
            }
            ...
            if (EntranceAddress2 != 0)
            {
                addressValuePairs.Add(EntranceAddress2, entranceX);
                addressValuePairs.Add(EntranceAddress2 + 0x2, entranceY);
                addressValuePairs.Add(EntranceAddress2 + 0x5, targetArea);
                addressValuePairs.Add(EntranceAddress2 + 0x6, targetRoom);
                addressValuePairs.Add(EntranceAddress2 + 0x7, layerOrHeight);
                addressValuePairs.Add(EntranceAddress2 + 0x8, animation);
                addressValuePairs.Add(EntranceAddress2 + 0x9, facingDirection);
            }

            if (EntranceAddress3 != 0)
            {
                addressValuePairs.Add(EntranceAddress3, entranceX);
                addressValuePairs.Add(EntranceAddress3 + 0x2, entranceY);
                addressValuePairs.Add(EntranceAddress3 + 0x5, targetArea);
                addressValuePairs.Add(EntranceAddress3 + 0x6, targetRoom);
                addressValuePairs.Add(EntranceAddress3 + 0x7, layerOrHeight);
                addressValuePairs.Add(EntranceAddress3 + 0x8, animation);
                addressValuePairs.Add(EntranceAddress3 + 0x9, facingDirection);
            }
