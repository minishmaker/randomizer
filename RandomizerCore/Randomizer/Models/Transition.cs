...
internal class Transition : ITransition
{
    ...
    public virtual Dictionary<uint, object> GetTransitionOffsets(byte targetArea, byte targetRoom, byte layerOrHeight,
        byte animation, ushort entranceX, ushort entranceY, byte facingDirection, uint entranceAddress = 0,
        uint greenWarpAddress = 0, uint elementGetAddress = 0, uint holeTransitionAddress = 0)
    {
